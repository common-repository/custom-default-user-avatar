...
$wpua_avatar_default = get_option( 'avatar_default_custom_default_user_avatar' );
...
// Check for updates
$wpua_default_avatar_updated = get_option( 'custom_default_user_avatar_default_avatar_updated' );
$wpua_users_updated          = get_option( 'custom_default_user_avatar_users_updated' );
$wpua_media_updated          = get_option( 'custom_default_user_avatar_media_updated' );
