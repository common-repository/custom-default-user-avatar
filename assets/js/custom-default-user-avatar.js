	...
	wp.media.wpUserAvatar = {
		...
		set: function(a) {
			...
			if ( b.post.wpUserAvatarId && b.post.wpUserAvatarSrc ) {
				$('#custom-default-user-avatar' + id).val( b.post.wpUserAvatarId );
		...
		frame: function() {
			...
			this._frame.on('open', function() {
				var a = $('#custom-default-user-avatar' + id).val();
...
jQuery(function($) {
	...
	var a = $('#custom-default-user-avatar').val();
	...
	$('body').on('click', '#wpua-undo', function(e) {
		...
		$('#custom-default-user-avatar').val(a);
		$('#custom_default_user_avatar_radio').trigger('click');
	});
});
...
jQuery(function($) {
	...
	var a = $('#custom-default-user-avatar-existing').val();
	...
	$('body').on('click', '#wpua-undo-existing', function(e) {
		...
		$('#custom-default-user-avatar-existing').val(a);
		$('#custom_default_user_avatar_radio').trigger('click');
	});
});
